...
public:
	...
	boolean summertime_EU(const uint8_t tzHours);
...
public:
	...
	// PUBLIC FUNCTIONS Paul Str DS1307RTC.h  added for compatibility
	
	static bool read(tmElements_t &tm);
	static bool write(tmElements_t &tm);
	static bool chipPresent() { return true; }
	static time_t get()   // Aquire data from buffer and convert to time_t
	{
		tmElements_t tm;
	...
	static boolean  use_summertime_EU;
private:
	static bool exists;
